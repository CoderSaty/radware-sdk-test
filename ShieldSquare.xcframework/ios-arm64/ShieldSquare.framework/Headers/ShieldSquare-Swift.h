...
#ifndef SHIELDSQUARE_SWIFT_H
#define SHIELDSQUARE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ShieldSquare",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12ShieldSquare19PopupViewController")
...
@interface PopupViewController (SWIFT_EXTENSION(ShieldSquare)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC12ShieldSquare13SSURLProtocol")
@interface SSURLProtocol : NSURLProtocol
...
@interface SSURLProtocol (SWIFT_EXTENSION(ShieldSquare)) <NSURLSessionDataDelegate>
...
/// \param eventName Event on which the this trakEvents was called.
///
/// \param screenName The current screen the user is.
///
/// \param eventParams <#eventParams description#>
///
